...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : POSTO A2 - VL53L0X + Bluetooth USART1 + Debug USART2
  ******************************************************************************
  */
...
/*
   Soglia del posto occupato.
   900 mm = 90 cm.
   Se la distanza misurata è minore o uguale a 900 mm, il posto è occupato.
*/
#define SOGLIA_OCCUPATO_MM  900
...
int main(void)
{
  ...
  Serial_Print("\r\n====================================\r\n");
  Serial_Print("TEST POSTO A1 - VL53L0X + BLUETOOTH\r\n");
  Serial_Print("Posto monitorato: A1\r\n");
  ...
  Serial_Print("Soglia occupato: 900 mm\r\n");
  Serial_Print("====================================\r\n\r\n");
  ...
  {
    Serial_Print("ERRORE A1: VL53L0X non trovato su I2C.\r\n");
  ...
  if (!VL53L0X_Init())
  {
    Serial_Print("ERRORE A1: inizializzazione VL53L0X fallita.\r\n");
